...
- [MRC: Multipath Reliable Connection](04_README_MRC.md): The OCP multipath transport protocol for AI-scale Ethernet — per-packet spraying, out-of-order placement, selective retransmission (SACK/NACK), NSCC congestion control, EV state machine, routing modes (ECMP, Structured EV, SRv6), multi-plane topology, traffic classes, software API, and production impact.
