...
- [MRC: Multipath Reliable Connection](04_README_MRC.md): The OCP multipath transport protocol for AI-scale Ethernet — entropy values and per-packet spraying, multi-plane topology, routing modes (ECMP, Structured EV, SRv6), out-of-order placement, selective retransmission (SACK/NACK), lossy Ethernet with packet trimming, NSCC congestion control, the EV state machine, probe-based failure recovery, the software API, and production impact.
